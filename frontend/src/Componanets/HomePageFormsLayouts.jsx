export const HomeProductionLayout = () => {
  ...
  return (
    <div className="min-w-fit text-2xl  font-sans  bg-blue-400 rounded-2xl m-1 text-white">
...
export const HomeSelesLayput = () => {
  return (
    <div className="max-w-full font-sans text-white bg-red-400 rounded-2xl mr-1 ml-1">
